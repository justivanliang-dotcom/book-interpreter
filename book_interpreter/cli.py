...
from .parser import read_book_file
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p_interpret.add_argument("book", help="书籍文件路径（TXT/Markdown）")
    ...
    p_ask.add_argument("book", help="书籍文件路径（TXT/Markdown）")
